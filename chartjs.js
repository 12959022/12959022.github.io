...
var element_arc = core_element.extend({
	...
	draw: function() {
        ...
        if(vm.borderWidth > 0) {
            ctx.beginPath();
            ctx.arc(arc.x, arc.y, arc.outerRadius, arc.startAngle, arc.endAngle);
            ctx.arc(arc.x, arc.y, arc.outerRadius + vm.borderWidth, arc.endAngle, arc.startAngle, true);
            ctx.closePath();
            ctx.fill();
        } else {
            ctx.beginPath();
            ctx.arc(arc.x, arc.y, arc.innerRadius + vm.borderWidth, arc.startAngle, arc.endAngle);
            ctx.arc(arc.x, arc.y, arc.innerRadius, arc.endAngle, arc.startAngle, true);
            ctx.closePath();
            ctx.fill();
        }
